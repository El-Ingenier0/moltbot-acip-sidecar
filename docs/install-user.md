...
- `ACIP_EXTRACTOR_SECCOMP` (optional; Linux): set to `1` to deny network-related syscalls in the extractor helper. Requires libseccomp (`libseccomp2`, `libseccomp-dev`).
